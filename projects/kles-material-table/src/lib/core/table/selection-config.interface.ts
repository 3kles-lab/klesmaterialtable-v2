...
type SelectionConfigDef<T> = {
    ...
    key?: string;
    params?: () => Observable<T>;
    select?: (params: T, row: FormGroup, selected: boolean, filters?: { [key: string]: any }) => Observable<{ selected?: boolean; count?: number }>;
    selectAll?: (params: T, selected: boolean, filters: { [key: string]: any }) => Observable<{ selected: boolean; footer?: any; count?: number }>;
